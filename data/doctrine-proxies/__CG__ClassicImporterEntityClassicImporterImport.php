 ...
 */
class FromClassicWithLoveImport extends \FromClassicWithLove\Entity\FromClassicWithLoveImport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'job', 'undoJob', 'has_err', 'stats'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FromClassicWithLoveImport $proxy) {
